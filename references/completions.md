...
- **`# shellcheck shell=bash` is the first line.** The file has no shebang to declare its dialect, and a shebang on a file that is only ever sourced would be a dead line
